...
class hebao_hy_goods:
    ...
    def prizeList(self):
        prizeTypedict={'1':'积分','2':'生活缴费券','3':'话费满返券','4':'加油券','5':'金融满返券','6':'积分','7':'qita'}
        print('月月领会员日')
...
奖品1000积分,使用条件:积分商城,ID:JFMS20230007
    '''
    ck='act_sid=act-2b057847-3f56-4140-8815-054b145fb464; BSFIT_DFPUUID=ECP2UM4A09VBECRNQ5RO5C9J3HTNHBDF; BSFIT_EXPIRATION=1733854152549; BSFIT_DEVICEID=b0N-dsZs1iqamOsg0Q-2GYRq_c0jm7PzfLWdr-zgGG0Dd02hfc_FqFFarumcrqOJofVc0PTRWXmbFEB4bl4rUWMiREhBZ2CaGMvBA2PJcwiTzHtOrxx6OvKZ41aH-HrSQe43GQCTb8GZqFS-vvm8uNU-c6TqOwB0'
