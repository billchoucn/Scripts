# 软件：中国移动
# 功能：心愿金签到
# 抓包 移动APP抓包，闪退换旧版本9.，先开抓包进，biz-orange/LN/uamonekeylogin/autoLogin 请求体全部
# 变量：xyjck
...
reward_name = '2.5元话费券'  # 填写兑换奖品名称 ,0.5/1、1.5/2话费券
user_agents = {
...
class HB:
    ...
    def get_sso_token(self):
        url_pattern = 'biz-orange/LN/uamonekeylogin/autoLogin'
